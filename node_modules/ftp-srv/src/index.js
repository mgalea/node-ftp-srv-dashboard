...
class FtpServer extends EventEmitter {
  constructor(options = {}) {
    ...
    const serverConnectionHandler = (socket) => {
      ...
      socket.once('close', () => this.emit('disconnect', {
        connection,
        id: connection.id
      }));
    ...
    const serverOptions = Object.assign({}, this.isTLS ? this.options.tls : {}, {
      pauseOnConnect: true
    });
  ...
  listen() {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.server.listen(this.url.port, this.url.hostname, (err) => {
        ...
        resolve('Listening on port ' + this.url.port);
      });
    });
  }
